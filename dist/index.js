    ...
    module2.exports = (input) => {
      ...
      const check = (header, opts) => {
        ...
        for (let i2 = 0; i2 < header.length; i2++) {
          if (header[i2] !== buf[i2 + opts.offset]) {
            return false;
          }
        }
        return true;
      ...
      if (check([26, 69, 223, 163])) {
        ...
        if (idPos >= 0) {
          ...
          const findDocType = (type) => Array.from(type).every((c, i2) => sliced[docTypePos + i2] === c.charCodeAt(0));
...
var require_readable = __commonJS({
  "node_modules/.pnpm/readable-stream@2.3.8/node_modules/readable-stream/readable.js"(exports, module2) {
    ...
    if (process.env.READABLE_STREAM === "disable" && Stream3) {
      ...
      exports = module2.exports = Stream3.Readable;
      exports.Readable = Stream3.Readable;
      exports.Writable = Stream3.Writable;
      exports.Duplex = Stream3.Duplex;
      exports.Transform = Stream3.Transform;
      exports.PassThrough = Stream3.PassThrough;
...
var require_bl = __commonJS({
  "node_modules/.pnpm/bl@1.2.3/node_modules/bl/bl.js"(exports, module2) {
    ...
    BufferList.prototype.copy = function copy(dst, dstStart, srcStart, srcEnd) {
      ...
      if (srcEnd <= 0)
        return dst || Buffer4.alloc(0);
      var copy2 = !!dst, off = this._offset(srcStart), len = srcEnd - srcStart, bytes = len, bufoff = copy2 && dstStart || 0, start = off[1], l, i2;
...
var require_headers = __commonJS({
  "node_modules/.pnpm/tar-stream@1.6.2/node_modules/tar-stream/headers.js"(exports) {
    ...
    function parse256(buf) {
      ...
      var zero = false;
      var tuple = [];
      for (var i2 = buf.length - 1; i2 > 0; i2--) {
        var byte = buf[i2];
        if (positive)
          tuple.push(byte);
        else if (zero && byte === 0)
    ...
    exports.decodePax = function(buf) {
      ...
      while (buf.length) {
        ...
        while (i2 < buf.length && buf[i2] !== 32)
          i2++;
        var len = parseInt(buf.slice(0, i2).toString(), 10);
        if (!len)
          return result;
        var b = buf.slice(i2 + 1, len - 1).toString();
...
var require_file_type2 = __commonJS({
  "node_modules/.pnpm/file-type@6.2.0/node_modules/file-type/index.js"(exports, module2) {
    "use strict";
    var toBytes = (s2) => Array.from(s2).map((c) => c.charCodeAt(0));
    ...
    module2.exports = (input) => {
      ...
      const check = (header, opts) => {
        ...
        for (let i2 = 0; i2 < header.length; i2++) {
          if (opts.mask) {
            if (header[i2] !== (opts.mask[i2] & buf[i2 + opts.offset])) {
              return false;
            }
          } else if (header[i2] !== buf[i2 + opts.offset]) {
            return false;
          }
        }
        return true;
      ...
      if (check([80, 75, 3, 4])) {
        ...
        if (check(oxmlContentTypes, { offset: 30 }) || check(oxmlRels, { offset: 30 })) {
          ...
          const nextZipHeaderIndex = (arr) => arr.findIndex((el, i2, arr2) => arr2[i2] === 80 && arr2[i2 + 1] === 75 && arr2[i2 + 2] === 3 && arr2[i2 + 3] === 4);
...
var require_stream2 = __commonJS({
  "node_modules/.pnpm/seek-bzip@1.0.6/node_modules/seek-bzip/lib/stream.js"(exports, module2) {
    ...
    Stream3.prototype.read = function(buffer, bufOffset, length) {
      var bytesRead = 0;
    ...
    Stream3.prototype.seek = function(new_pos) {
      throw new Error("abstract method seek() not implemented");
    };
    Stream3.prototype.writeByte = function(_byte) {
      throw new Error("abstract method readByte() not implemented");
    };
    Stream3.prototype.write = function(buffer, bufOffset, length) {
      var i2;
    ...
    Stream3.prototype.flush = function() {
    };
    module2.exports = Stream3;
  }
});
  ...
  "node_modules/.pnpm/seek-bzip@1.0.6/node_modules/seek-bzip/lib/index.js"(exports, module2) {
    ...
    Bunzip.prototype._get_next_block = function() {
      ...
      for (j = 0; j < groupCount; j++) {
        ...
        for (i2 = minLen; i2 < maxLen; i2++) {
          pp += temp[i2];
          hufGroup.limit[i2] = pp - 1;
          pp <<= 1;
          t2 += temp[i2];
          hufGroup.base[i2 + 1] = pp - t2;
        }
      ...
      for (i2 = 0; i2 < dbufCount; i2++) {
        uc = dbuf[i2] & 255;
        dbuf[byteCount[uc]] |= i2 << 8;
        byteCount[uc]++;
      }
    ...
    bzip2.decompress = function(bits, stream, buf, bufsize, streamCRC) {
      ...
      for (i2 = 0; i2 < 16; i2++) {
        if (t2 & 1 << 15 - i2) {
          ...
          for (j = 0; j < 16; j++) {
            if (k & 1 << 15 - j) {
              this.symToByte[symTotal++] = 16 * i2 + j;
            }
          }
        }
      }
    ...
    function unbzip2Stream() {
      ...
      function decompressBlock(push) {
        if (!blockSize) {
          ...
          streamCRC = bz2.decompress(bitReader, f3, buf, bufsize, streamCRC);
          if (streamCRC === null) {
            blockSize = 0;
            return false;
          } else {
...
var require_buffer_stream = __commonJS({
  "node_modules/.pnpm/get-stream@2.3.1/node_modules/get-stream/buffer-stream.js"(exports, module2) {
    ...
    module2.exports = function(opts) {
      ...
      var len = 0;
      var ret = [];
      var stream = new PassThrough3({ objectMode });
      if (encoding) {
  ...
  "node_modules/.pnpm/pify@2.3.0/node_modules/pify/index.js"(exports, module2) {
    ...
    var pify = module2.exports = function(obj, P, opts) {
      ...
      return Object.keys(obj).reduce(function(ret2, key) {
        var x2 = obj[key];
        ret2[key] = typeof x2 === "function" && filter(key) ? processFn(x2, P, opts) : x2;
        return ret2;
      }, ret);
    };
    pify.all = pify;
...
var require_decompress = __commonJS({
  "node_modules/.pnpm/decompress@4.2.1/node_modules/decompress/index.js"(exports, module2) {
    ...
    var runPlugins = (input, opts) => {
      ...
      return Promise.all(opts.plugins.map((x2) => x2(input, opts))).then((files) => files.reduce((a, b) => a.concat(b)));
    };
    ...
    var extractFile = (input, output, opts) => runPlugins(input, opts).then((files) => {
      if (opts.strip > 0) {
        files = files.map((x2) => {
          x2.path = stripDirs(x2.path, opts.strip);
          return x2;
        }).filter((x2) => x2.path !== ".");
      }
      ...
      return Promise.all(files.map((x2) => {
        const dest = path2.join(output, x2.path);
        const mode = x2.mode & ~process.umask();
        const now = /* @__PURE__ */ new Date();
        if (x2.type === "directory") {
          return makeDir(output).then((outputPath) => fsP.realpath(outputPath)).then((realOutputPath) => safeMakeDir(dest, realOutputPath)).then(() => fsP.utimes(dest, now, x2.mtime)).then(() => x2);
        }
        return makeDir(output).then((outputPath) => fsP.realpath(outputPath)).then((realOutputPath) => {
          ...
          if (x2.type === "link") {
            return fsP.link(x2.linkname, dest);
          }
          if (x2.type === "symlink" && process.platform === "win32") {
            return fsP.link(x2.linkname, dest);
          }
          if (x2.type === "symlink") {
            return fsP.symlink(x2.linkname, dest);
          }
          return fsP.writeFile(dest, x2.data, { mode });
        }).then(() => x2.type === "file" && fsP.utimes(dest, now, x2.mtime)).then(() => x2);
      }));
    });
...
var downloadMicromamba = async (url) => {
  ...
  const downloadMicromamba2 = fetch(url).then((response) => response.arrayBuffer()).then((buffer) => Buffer.from(buffer)).then((buffer) => {
  ...
  Promise.all([mkDir, downloadMicromamba2]).then(([, files]) => {
